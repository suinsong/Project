...
public class NamesDTO {
	...
	public NamesDTO(int 회원번호, String iD, String 비밀번호, String 이름, String 전화번호, String 주소, String 성별, String 출석횟수,
	...
	public String toString() {
		return "NamesDTO [회원번호=" + 회원번호 + ", ID=" + ID + ", 비밀번호=" + 비밀번호 + ", 이름=" + 이름 + ", 전화번호=" + 전화번호 + ", 주소="
